...
const T = {
  en: {
    ...
    who2: 'Free, no login, trilingual, low-bandwidth, printable offline briefs, and built to WCAG accessibility standards.',
    who3L: 'Toward the UN goals',
    who3: 'SDG 13 climate action, 11 resilient communities, 2 zero hunger, and 1 and 10.',
    sysTitle: 'The system',
    ...
    resp4L: 'Uncertainty & bias', resp4: 'Conformal prediction gives calibrated risk bands; the rice-transplant false positive and both spatial folds are documented and published, failures included.',
  ...
  hi: {
    ...
    who2L: 'सबकी पहुँच',
    who2: 'मुफ़्त, बिना लॉगिन, त्रिभाषी, कम-बैंडविड्थ, प्रिंट-योग्य ऑफ़लाइन ब्रीफ़, और WCAG सुलभता मानकों पर बना।',
    who3L: 'UN लक्ष्यों की ओर',
    who3: 'SDG 13 जलवायु कार्रवाई, 11 सुदृढ़ समुदाय, 2 शून्य भूख, और 1 व 10।',
    sysTitle: 'सिस्टम',
    ...
    resp4L: 'अनिश्चितता व पक्षपात', resp4: 'Conformal prediction कैलिब्रेटेड जोखिम बैंड देता है; धान-रोपाई का ग़लत-सकारात्मक और दोनों स्थानिक फ़ोल्ड प्रलेखित व प्रकाशित, असफलताएँ सहित।',
  ...
  pa: {
    ...
    who2L: 'ਸਭ ਤੱਕ ਪਹੁੰਚ',
    who2: 'ਮੁਫ਼ਤ, ਬਿਨਾਂ ਲੌਗਿਨ, ਤਿੰਨ-ਭਾਸ਼ੀ, ਘੱਟ-ਬੈਂਡਵਿਡਥ, ਪ੍ਰਿੰਟ-ਯੋਗ ਆਫ਼ਲਾਈਨ ਬਰੀਫ਼, ਅਤੇ WCAG ਪਹੁੰਚਯੋਗਤਾ ਮਿਆਰਾਂ ਉੱਤੇ ਬਣਿਆ।',
    who3L: 'UN ਟੀਚਿਆਂ ਵੱਲ',
    who3: 'SDG 13 ਜਲਵਾਯੂ ਕਾਰਵਾਈ, 11 ਮਜ਼ਬੂਤ ਭਾਈਚਾਰੇ, 2 ਜ਼ੀਰੋ ਭੁੱਖ, ਅਤੇ 1 ਤੇ 10।',
    sysTitle: 'ਸਿਸਟਮ',
    ...
    resp4L: 'ਅਨਿਸ਼ਚਿਤਤਾ ਤੇ ਪੱਖਪਾਤ', resp4: 'Conformal prediction ਕੈਲੀਬ੍ਰੇਟਿਡ ਜੋਖਮ ਬੈਂਡ ਦਿੰਦਾ ਹੈ; ਝੋਨਾ-ਲਵਾਈ ਦਾ ਗ਼ਲਤ-ਸਕਾਰਾਤਮਕ ਤੇ ਦੋਵੇਂ ਸਥਾਨਿਕ ਫ਼ੋਲਡ ਦਸਤਾਵੇਜ਼ੀ ਤੇ ਪ੍ਰਕਾਸ਼ਿਤ, ਅਸਫ਼ਲਤਾਵਾਂ ਸਮੇਤ।',
      ...
      <Section variant="transparent" padding={0} dividers={['top']}>
        <HStack justify="center" width="100%">
          <VStack width="100%" maxWidth={1080} paddingInline={4} paddingBlock={5} gap={1}>
            <Text type="supporting" color="secondary">SAILAAB · built by a Punjab student during the 2026 monsoon · India AI Impact Festival 2026 · Code MIT · Maps &amp; tables CC-BY-4.0 · Contains modified Copernicus Sentinel &amp; EMS-GFM data</Text>
