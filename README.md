...
tests/      pytest, every sailaab/ module covered (465 tests)
...
python -m pytest -q          # 465 tests; Earth-Engine-marked tests excluded by default
```
